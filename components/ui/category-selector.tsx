        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role="combobox"
                    aria-expanded={open}
                    className="w-full max-w-full relative flex justidy-center sm:justify-start sm:flex-none items-center space-x-w bg-blue-500 hover:bg-blue-700 hover:text-white text-white font-bold py-2 px-4 rounded"
                >
